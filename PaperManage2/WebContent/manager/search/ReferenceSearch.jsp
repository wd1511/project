...
<body>
    <div id="homepage_search" style="top:60px;">
        ...
        <div class="paper_area">
            ...
            <div class="paper">
                <h2><s:property value="#id.referenceName"/></h2>
                <s:a href="./ReferenceInfo.action?referenceInfo.referenceName=%{#id.referenceName}&referenceInfo.id=%{#id.id}&referenceInfo.author=%{#id.author}&referenceInfo.keywords=%{#id.keywords}&referenceInfo.sort1=%{#id.sort1}&referenceInfo.sort2=%{#id.sort2}&referenceInfo.sort3=%{#id.sort3}&referenceInfo.publication=%{#id.publication}&referenceInfo.workload=%{#id.workload}&referenceInfo.date=%{#id.date}">something</s:a>
            </div>
            </s:iterator>
