...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="tourist/paper/1.css"/>
...
<body>
    <div class="area">
     <s:iterator value="paperSort1" id="id">
        <figure>
                <img src="tourist/paper/images/portfolio/1.jpg"/>
                <figcaption>
                    <h2><s:property value="#id"/></h2>
                    <div class="scription">
                        <s:a href="./tourist/paper/PaperSort2.action?sort1=%{#id}"><p>a small discription for the kind</s:a> </p>
                    </div>
                </figcaption>
        </figure>
    </s:iterator>
