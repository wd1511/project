...
<body>
     ...
     <div class="area">
     <s:iterator value="referenceSort2" id="id">
        <figure>
                <img src="images/portfolio/2.jpg"/>
                <figcaption>
                    <h2><s:property value="#id"/></h2>
                    <div class="scription">
                        <s:a href="./ReferenceSort3.action?sort2=%{#id}"><p>a small discription for the kind</s:a> </p>
                    </div>
                </figcaption>
        </figure>
    </s:iterator>
    ...
    <div class="slidebar" id="menu" >
        ...
        <div class="menu_option">
            <img src="../../jpg/分类.png" />
            <a class="txt" href="ReferenceSort1.action">参考文献分类</a>
        </div>
