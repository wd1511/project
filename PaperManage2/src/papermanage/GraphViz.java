...
public class GraphViz {
     ...
     */
    private final static String cfgProp = GraphViz.class.getResource("/papermanage/config.properties").getFile();
    ...
    public static void createDotGraph(String dotFormat, String fileName) {
        ...
        gv.decreaseDpi();
        gv.decreaseDpi();
        String path=ServletActionContext.getServletContext().getRealPath("/graph/");
        File file =new File(path);
        if(!file.exists()) {
          file.mkdirs();
        }
        String s=path + fileName + "." + type;
        File out = new File(s);
        gv.writeGraphToFile(gv.getGraph(gv.getDotSource(), type), out);
    }
