...
public class Paper {
	...
	public Paper(int id,String paperName,String author,String keywords,String sort1,String sort2,String sort3,String publication,String workload,String date,String reference){
		this.id=id;
